...
public class MenuActivity1 extends AppCompatActivity {
        ...
        mAuthListener= new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if(firebaseAuth.getCurrentUser()==null){
                    ...
                    Intent loginIntent = new Intent(MenuActivity1.this,MainActivity.class);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<Food,MenuActivity.FoodViewHolder> FBRA= new FirebaseRecyclerAdapter<Food, MenuActivity.FoodViewHolder>(
                Food.class,
                R.layout.singlemenuitem,
                MenuActivity.FoodViewHolder.class,
                mDatabase
        ) {
            @Override
            protected void populateViewHolder(MenuActivity.FoodViewHolder viewHolder, Food model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent singleFoodActivity = new Intent(MenuActivity1.this,SingleFoodActivity1.class);
